#ifndef TopAnalysis_KinematicReconstruction_analysisUtils_h
#define TopAnalysis_KinematicReconstruction_analysisUtils_h
...
#include "TopAnalysis/KinematicReconstruction/interface/classesFwd.h"

namespace topKinReco{
