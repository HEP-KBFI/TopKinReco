#ifndef TopAnalysis_KinematicReconstruction_KinematicReconstruction_h
#define TopAnalysis_KinematicReconstruction_KinematicReconstruction_h
...
#include "TopAnalysis/KinematicReconstruction/interface/sampleHelpers.h"
...
public:
    ...
    KinematicReconstruction(const int minNumberOfBtags, const double btag_wp, const bool preferBtags, const bool massLoop =false);
...
public:
    ...
    /// Constructor
    KinematicReconstructionScaleFactors(const std::vector<topKinReco::Channel::Channel>& channels,
                                        const topKinReco::Systematic::Systematic& systematic);
    
    /// Destructor
    ~KinematicReconstructionScaleFactors(){}
    
    /// Prepare scale factors per channel
    void prepareChannel(const topKinReco::Channel::Channel& channel);
...
private:
    ...
    std::map<topKinReco::Channel::Channel, double> m_scaleFactor_;
